...
If you want to see how far distillation and extreme quantization can go, Prism ML's Bonsai 27B takes the same idea to the edge: a 27B-class model distilled into binary and ternary weights, small enough to run on a phone or laptop. I cover the practical side in [my hands-on test of the 1-bit model](./can-a-3-9-gb-model-really-code-testing-bonsai-27b-1-bit-on-a-laptop/) and the technical choices in [how Bonsai 27B packs 27B-class reasoning into 1-bit weights](./how-bonsai-27b-packs-27b-class-reasoning-into-1-bit-weights/).
